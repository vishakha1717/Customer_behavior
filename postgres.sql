...
select item_purchased, ROUND(avg(review_rating::NUMERIC),2)as avg_products_rating
from customer
...
--Q5.Do subscribed customers spend more? compare average spend and total revenue between subscribes and non_subscribes?
